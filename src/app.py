...
@app.route('/artefatos_scrum_pt2')
def artefatos_pt2():
    return render_template('artefatos2.html')
...
@app.route('/video_dor')
def video_dor():
    return render_template('video-dor.html')

@app.route('/video_kanban')
def video_kanban():
    return render_template('/kanbanvideo.html')

@app.route('/video_planning_poker')
def video_planning_poker():
    return render_template('/planningpokervideo.html')
